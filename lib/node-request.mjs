 ...
 *
 * Also published as `@johnhenry/leserve/node-request` for other packages that need
 * their own Node HTTP bridge to speak the same `Request` shape @johnhenry/leserve
